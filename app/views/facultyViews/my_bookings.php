        ...
        <div class="modal-body">
          ...
          <div class="row g-2">
            <div class="col">
              ...
              <input id="editStartTime" name="edit_start" data-field="edit_start" type="time" class="form-control"
                required />
            </div>
            <div class="col">
          ...
          <div class="mb-2 mt-2">
            ...
            <textarea id="editPurpose" name="edit_purpose" data-field="edit_purpose" rows="3"
          ...
          <script>
            ...
            const editDateFaculty = document.getElementById('editDate');
            const tomorrowEditF = new Date();
            tomorrowEditF.setDate(tomorrowEditF.getDate() + 1);
            editDateFaculty.min = tomorrowEditF.toISOString().split('T')[0];
          </script>
        </div>
